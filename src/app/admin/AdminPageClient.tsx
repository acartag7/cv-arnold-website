 ...
 *
 * This is a placeholder admin UI. Phase 1 of the implementation plan
 * will replace this with a full-featured CMS.
 */
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              {activeSection === 'experience' && (
                <div className="space-y-6">
                  ...
                  <p className="text-gray-600">
                    Experience editing will be available in Phase 2 of the Admin
                    CMS. For now, please edit the JSON file directly.
                  </p>
                </div>
              )}
              ...
              {activeSection === 'achievements' && (
                <div className="space-y-6">
                  ...
                  <p className="text-gray-600">
                    Achievement editing will be available in Phase 2 of the
                    Admin CMS. For now, please edit the JSON file directly.
                  </p>
                </div>
              )}
              ...
              {!['personal', 'summary', 'experience', 'achievements'].includes(
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-gray-600">
                    This section editor will be available in Phase 2 of the
                    Admin CMS. For now, please edit the JSON file directly.
                  </p>
                </div>
              )}
