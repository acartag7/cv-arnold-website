      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-lg text-[var(--text-muted)] max-w-2xl mx-auto">
            Ready to discuss platform engineering opportunities, cloud architecture, or technical collaboration
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <div>
              <h3 className="text-xl font-semibold text-[var(--text)] mb-6">Get In Touch</h3>
                  ...
                  const content = (
                    <div className="flex items-center space-x-4 p-4 rounded-xl bg-[var(--background)]/60 hover:bg-[var(--background)] border border-[var(--primary)]/10 hover:border-[var(--primary)]/30 transition-all duration-300 group">
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-semibold text-[var(--text)] mb-1">{contact.label}</h4>
                        <p className="text-sm text-[var(--text-muted)] mb-1">{contact.value}</p>
                        <p className="text-xs text-[var(--primary)]">{contact.description}</p>
                      </div>
                    </div>
                  );
            ...
            <div>
              <h3 className="text-xl font-semibold text-[var(--text)] mb-6">Social & Professional</h3>
              <div className="space-y-4">
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-semibold text-[var(--text)] mb-1">{social.label}</h4>
                        <p className="text-sm text-[var(--text-muted)] mb-1">{social.value}</p>
                        <p className="text-xs text-[var(--primary)]">{social.description}</p>
                      </div>
                    </a>
                  );
                })}
          ...
          >
            <div className="p-8 rounded-xl bg-[var(--background)]/60 border border-[var(--primary)]/10">
              ...
              <p className="text-[var(--text-muted)] mb-6 leading-relaxed">
                I&apos;m always open to discussing new opportunities, technical challenges, or sharing insights about platform engineering and cloud architecture.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-6 rounded-xl bg-[var(--background)]/60 border border-[var(--primary)]/10 text-center">
                <div className="text-2xl font-bold text-[var(--primary)] mb-1">8+</div>
                <div className="text-sm text-[var(--text-muted)]">Years Experience</div>
              </div>
              <div className="p-6 rounded-xl bg-[var(--background)]/60 border border-[var(--primary)]/10 text-center">
                <div className="text-2xl font-bold text-[var(--primary)] mb-1">9</div>
                <div className="text-sm text-[var(--text-muted)]">Certifications</div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-xl bg-[var(--primary)]/10 border border-[var(--primary)]/20">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <span className="font-semibold text-[var(--text)]">Available for Opportunities</span>
              </div>
              <p className="text-sm text-[var(--text-muted)]">
                Open to platform engineering roles, consulting projects, and technical collaborations
              </p>
            </div>
          </motion.div>
        </div>
